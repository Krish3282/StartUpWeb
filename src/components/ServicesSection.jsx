    ...
    <section className='py-20 container mx-auto px-4 sm:px-6 lg:px-8'>
      <div className='felx flex-col md:flex-row  items-center justify-between gap-12 lg:gap-24'> 
        ...
        <div className='w-full md:w-1/3'>
            ...
            <p className=' capitalize text-gray-600 text-lg mb-4 md:w-4/5'>Discuss your goals,determine success metrics, identify problems</p>
            <div className='space-y-3'>
                ...
                <div className='flex items-center gap-2'>
                    ...
                    <span className='text-gray-600'>Mix design content strategy</span>
                </div>
                {/*  */}
                <div className='flex items-center gap-2'>
                    <div className='w-5 h-5 rounded-full bg-indigo-100 flex items-center justify-center'>
