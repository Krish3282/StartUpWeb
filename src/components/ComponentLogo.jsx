...
const ComponentLogo = () => {
  ...
  return (
    <div className='w-full overflow-hidden container mx-auto py-20 gap-8  flex  sm:flex-row flex-col sm:items-center items-start'>
      <div className="w-[300px] shrink-0 text-gray-600 border-l-4 border-blue-500 bg-white py-2 z-10 px-4 sm:text-base text-xl font-semibold text-left">
        Proud Partner at <br />Motstpot & Segment</div>
      ...
      <div className='flex animate-marquee whitespace-nowrap'>
        {logos.map((logo,index) =>(
          ...
          {/* duplicate the map for more ogo */}
          <div className='flex animate-marquee whitespace-nowrap'>
        {logos.map((logo,index) =>(
